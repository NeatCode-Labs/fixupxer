# FixupXer Release Notes

## v1.1.1 (Latest)

### 🎉 New Features
- **Added Monero Donation Option**: Users can now support development with Monero cryptocurrency
  - Added clickable "Monero (click to copy address)" text in donate dialog
  - One-tap copy functionality with toast feedback "Address copied!"
  - Improved donate dialog UI with better button layout and spacing
...
- APK Size: ~7.4MB
- AAB Size: ~9.9MB
- Certificate fingerprints remain unchanged:
